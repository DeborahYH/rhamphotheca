...
with open("wikiaves_data/sao_paulo_grid.csv", "r") as file:
    ...
    for row in reader:
        ...
        # HTML code containg the desired data
...
df.to_csv(os.path.join("wikiaves_data", "sao_paulo_cards.csv"), index=False)